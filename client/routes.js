...
import {Login, Signup, UserHome, AllProducts, SingleProduct, Cart, Checkout, Payment, OrderConfirmation, ProductForm} from './components'
  ...
  render () {
    ...
    return (
      <Switch>
        ...
        <Route path="/product/:id/edit" render={() => <ProductForm products={products} />} />
